...
namespace PalTrackerTests
{
  public class InMemoryTimeEntryRepositoryTest
  {
    ...
    public void Create()
    {
      var expected = new TimeEntry(1, 222, 333, new DateTime(2010, 08, 01, 12, 00, 01), 24);

      var created = _repository.Create(new TimeEntry(222, 333, new DateTime(2010, 08, 01, 12, 00, 01), 24));
    ...
    public void Find()
    {
      var timeEntry = _repository.Create(new TimeEntry(222, 333, new DateTime(2010, 08, 01, 12, 00, 01), 24));
    ...
    {
      _repository.Create(new TimeEntry(222, 333, new DateTime(2010, 08, 01, 12, 00, 01), 24));
    ...
    public void List()
    {
      var timeEntry1 = _repository.Create(new TimeEntry(222, 333, new DateTime(2010, 08, 01, 12, 00, 01), 24));
      var timeEntry2 = _repository.Create(new TimeEntry(888, 777, new DateTime(2015, 09, 02, 11, 30, 00), 12));
